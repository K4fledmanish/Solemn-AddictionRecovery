...
import com.example.solemn_addictionrecovery.env.Logger;

import com.google.android.material.floatingactionbutton.FloatingActionButton;

import com.example.solemn_addictionrecovery.customview.OverlayView;
import com.example.solemn_addictionrecovery.customview.OverlayView.DrawCallback;
import com.example.solemn_addictionrecovery.env.BorderedText;
import com.example.solemn_addictionrecovery.env.ImageUtils;
import com.example.solemn_addictionrecovery.tflite.Classifier;
import com.example.solemn_addictionrecovery.tflite.TFLiteObjectDetectionAPIModel;
import com.example.solemn_addictionrecovery.tracking.MultiBoxTracker;
import com.example.solemn_addictionrecovery.TFMainActivity;
 ...
 * objects.
 */
public class DetectorActivity extends TFCameraActivity implements OnImageAvailableListener {
                            ...
                            public void onClick(View v) {
                                for (final Classifier.Recognition result : results) {
                                    ...
                                    if (location != null && result.getConfidence() >= finalMinimumConfidence) {
                                        ...
                                        result.setLocation(location);
                                        mappedRecognitions.add(result);
                                        TFMainActivity.getInstance().addFood(String.format(result.getTitle()));
                                    }
                                }
                                finish();
                            }
