    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.nav_account:
                Intent intent3 = new Intent(InfoActivity.this, ProfileActivity.class);
                startActivity(intent3);
                break;

            case R.id.nav_substance:
                Intent intent5 = new Intent(InfoActivity.this, SubstanceActivity.class);
                startActivity(intent5);
                break;

            case R.id.nav_alcohol:
                Intent intent4 = new Intent(InfoActivity.this, AlcoholActivity.class);
    ...
    private void signOut() {
        mGoogleSignInClient.signOut().addOnCompleteListener(this, new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                Toast.makeText(InfoActivity.this, "Signed out successfully!", Toast.LENGTH_LONG).show();
